...
data AStatement 
  ...
  | functionDefStmt(str name, list[str] params, list[AStatement] stmts, str endName)
  | dataAbstraction(str name, list[str] identifiers, ARepDef repDef, 
                    list[AFunctionDef] functions, str endName)
  ;

data AFunctionDef = afunctionDef(str name, list[str] params, list[AStatement] stmts, str endName);
